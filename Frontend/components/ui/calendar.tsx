  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-slate-500 rounded-sm w-9 font-normal text-[0.8rem] dark:text-slate-400",
      ...
      components={{
        //PrevButton: (props: React.JSX.IntrinsicAttributes & Omit<LucideProps, "ref"> & React.RefAttributes<SVGSVGElement>) => <ChevronLeft className="h-4 w-4" {...props} />,
        //NextButton: (props: React.JSX.IntrinsicAttributes & Omit<LucideProps, "ref"> & React.RefAttributes<SVGSVGElement>) => <ChevronRight className="h-4 w-4" {...props} />,
      }}
      {...props}
    />
  )
