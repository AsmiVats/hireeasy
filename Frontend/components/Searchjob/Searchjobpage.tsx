...
export default function SearchJobPage() {
  ...
  const performSearch = useCallback(async (criteria, page = 1) => {
    ...
    try {
      ...
      const response = await fetch(`${BASE_URL}/jobSeeker/searchJobs`, {
        method: 'POST',
        headers: {
      ...
      <div className="w-full mx-auto pr-4">
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            <SearchResult results={searchResults} isLoading={isLoading} error={error} 
