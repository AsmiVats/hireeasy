export const bookDemoConfirmationToUser = (name, date, time) => {
  return `
      <!DOCTYPE html>
<html>
<head>
...
<body style="font-family: Arial, sans-serif; background-color: #f4f7fc; margin: 0; padding: 0;">
  ...
  <!-- 1. Demo Booking Confirmation (Team Notification) -->
...
;">Now</span><span style="color: #002244;">Edge</span>
      ...
      <div style="font-size: 18px; margin-top: 10px;text-align: left; color:#009951;">Your Demo is Confirmed. We can't wait to connect !! </div>
    </div>
    <!-- Body Content -->
